...
export default function Dashboard() {
  ...
  const [todayRoutine] = useState(
    routines[new Date().getDay() % routines.length]
  );
            ...
            <CardContent className="space-y-4">
              <div className="space-y-4">
                ...
                <div className="text-center">
                  ...
                  <p className="text-sm text-gray-600">
                    You're feeling{" "}
                    {moodEmojis[mood[0] - 1]?.label.toLowerCase()}
                  </p>
                </div>
              </div>
              <Button
          ...
          <div className="grid gap-6 md:grid-cols-3">
            ...
            <Card className="border-0 bg-gradient-to-br from-teal-50 to-teal-100 rounded-3xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105">
              <CardContent className="p-6 text-center">
                ...
                <Button
                  size="sm"
                  className="bg-teal-400 hover:bg-teal-500 text-white rounded-full"
                >
                  Start Now
                </Button>
              </CardContent>
            ...
            <Card className="border-0 bg-gradient-to-br from-orange-50 to-orange-100 rounded-3xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105">
              <CardContent className="p-6 text-center">
                ...
                <p className="text-sm text-gray-600 mb-4">
                  30 min of mindful presence
                </p>
                <Button
                  size="sm"
                  className="bg-orange-400 hover:bg-orange-500 text-white rounded-full"
                >
                  Begin
                </Button>
              </CardContent>
                      ...
                      {[...Array(7)].map((_, i) => (
                        <div
                          ...
                          className={`w-3 h-3 rounded-full ${
                            i < streak ? "bg-purple-400" : "bg-gray-200"
                          }`}
                        />
                      ))}
                    </div>
