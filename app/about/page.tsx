    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-50 via-pink-50 to-green-50">
      ...
      <header className="px-4 lg:px-6 h-16 flex items-center backdrop-blur-sm bg-white/70 sticky top-0 z-50">
        ...
        <nav className="ml-auto flex items-center gap-6">
          ...
          <Link href="/about" className="text-sm font-medium text-purple-600 border-b-2 border-purple-400">
            About
          </Link>
      ...
      <main>
          ...
          <div className="container px-4 md:px-6 mx-auto">
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              ...
              <p className="max-w-[600px] text-gray-600 md:text-xl leading-relaxed">
                We believe every woman deserves wellness tools that honor her unique journey and natural rhythms.
              </p>
            </div>
          </div>
        </section>
            ...
            <div className="grid gap-12 lg:grid-cols-2 items-center">
              <div className="space-y-6">
                ...
                <p className="text-gray-600 text-lg leading-relaxed">
                  At Bloom, we're reimagining wellness for women. We understand that your body, mind, and spirit go
                  through natural cycles and changes. That's why we've created a platform that adapts to you—not the
                  other way around.
                </p>
                <p className="text-gray-600 leading-relaxed">
                  Our approach is gentle, evidence-based, and deeply respectful of the feminine experience. Whether
                  you're navigating hormonal changes, managing stress, or simply seeking more balance in your life,
                  we're here to support you with tools that truly understand women's wellness.
                </p>
              </div>
        ...
        <section className="w-full py-12 md:py-24 lg:py-32">
          <div className="container px-4 md:px-6 mx-auto">
            <div className="flex flex-col items-center justify-center space-y-4 text-center mb-12">
              <h2 className="text-3xl font-bold tracking-tight sm:text-4xl text-gray-800">Our Values</h2>
              <p className="max-w-[600px] text-gray-600 md:text-lg">These principles guide everything we do at Bloom</p>
            </div>
            <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-4">
              <Card className="border-0 bg-gradient-to-br from-purple-50 to-purple-100 rounded-3xl shadow-lg">
                <CardContent className="p-6 text-center">
                  ...
                  <h3 className="text-lg font-semibold mb-2 text-gray-800">Compassion</h3>
                  <p className="text-gray-600 text-sm">
                    We approach wellness with kindness, understanding that every woman's journey is unique and valid.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className="border-0 bg-gradient-to-br from-pink-50 to-pink-100 rounded-3xl shadow-lg">
                <CardContent className="p-6 text-center">
                  ...
                  <h3 className="text-lg font-semibold mb-2 text-gray-800">Evidence-Based</h3>
                  <p className="text-gray-600 text-sm">
                    All our content is grounded in scientific research and developed with women's health experts.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className="border-0 bg-gradient-to-br from-green-50 to-green-100 rounded-3xl shadow-lg">
                <CardContent className="p-6 text-center">
                  ...
                  <p className="text-gray-600 text-sm">
                    We believe in the power of women supporting women on their wellness journeys.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className="border-0 bg-gradient-to-br from-orange-50 to-orange-100 rounded-3xl shadow-lg">
                <CardContent className="p-6 text-center">
                  ...
                  <h3 className="text-lg font-semibold mb-2 text-gray-800">Privacy</h3>
                  <p className="text-gray-600 text-sm">
                    Your wellness data is sacred. We protect your privacy with the highest security standards.
                  </p>
                </CardContent>
              </Card>
            </div>
        ...
        <section className="w-full py-12 md:py-24 lg:py-32 bg-gradient-to-r from-purple-50 to-pink-50">
          <div className="container px-4 md:px-6 mx-auto">
            <div className="flex flex-col items-center justify-center space-y-4 text-center mb-12">
              <h2 className="text-3xl font-bold tracking-tight sm:text-4xl text-gray-800">Meet Our Team</h2>
              <p className="max-w-[600px] text-gray-600 md:text-lg">Passionate experts dedicated to women's wellness</p>
            </div>
              ...
              <Card className="border-0 bg-white/70 backdrop-blur-sm rounded-3xl shadow-lg">
                <CardContent className="p-6 text-center">
                  <div className="w-20 h-20 mx-auto mb-4 bg-gradient-to-r from-purple-200 to-pink-200 rounded-full flex items-center justify-center">
                    <span className="text-2xl font-semibold text-purple-600">SM</span>
                  </div>
                  <h3 className="text-lg font-semibold mb-1 text-gray-800">Dr. Sarah Martinez</h3>
                  <p className="text-purple-600 text-sm mb-3">Women's Health Specialist</p>
                  <p className="text-gray-600 text-sm">
              ...
              <Card className="border-0 bg-white/70 backdrop-blur-sm rounded-3xl shadow-lg">
                <CardContent className="p-6 text-center">
                  <div className="w-20 h-20 mx-auto mb-4 bg-gradient-to-r from-pink-200 to-orange-200 rounded-full flex items-center justify-center">
                    <span className="text-2xl font-semibold text-pink-600">AL</span>
                  </div>
                  <h3 className="text-lg font-semibold mb-1 text-gray-800">Aria Liu</h3>
                  <p className="text-pink-600 text-sm mb-3">Certified Yoga Instructor</p>
                  <p className="text-gray-600 text-sm">
              ...
              <Card className="border-0 bg-white/70 backdrop-blur-sm rounded-3xl shadow-lg">
                <CardContent className="p-6 text-center">
                  <div className="w-20 h-20 mx-auto mb-4 bg-gradient-to-r from-green-200 to-blue-200 rounded-full flex items-center justify-center">
                    <span className="text-2xl font-semibold text-green-600">MJ</span>
                  </div>
                  <h3 className="text-lg font-semibold mb-1 text-gray-800">Maya Johnson</h3>
                  <p className="text-green-600 text-sm mb-3">Nutritional Therapist</p>
                  <p className="text-gray-600 text-sm">
              ...
              <CardContent className="p-12 text-center relative">
                ...
                <div className="relative z-10">
                  ...
                  <p className="text-lg text-gray-600 mb-8 max-w-2xl mx-auto">
                    Ready to experience wellness that truly understands you? Join thousands of women who have found
                    their gentle path to better health.
                  </p>
                  <Button
                    onClick={() => setShowAuthModal(true)}
